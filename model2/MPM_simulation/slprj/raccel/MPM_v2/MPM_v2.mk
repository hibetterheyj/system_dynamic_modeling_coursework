...
MODEL                  = MPM_v2
MODULES                = rt_logging.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c MPM_v2.c MPM_v2_capi.c MPM_v2_data.c MPM_v2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE               = MPM_v2.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = E:\何宇杰\上课要点及其作业\大四\机电液建模\我方作业\model2\MPM_simulation
...
BUILDARGS              =  MODELLIB=MPM_v2lib.lib RSIM_SOLVER_SELECTION=2 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = MPM_v2_ref.rsp
MODELREF_INC_PATH         = 
COMPILER_COMMAND_FILE     = MPM_v2_comp.rsp
...
BUILDINFO_INCLUDES = $(BUILDINFO_INCLUDES);$(START_DIR)\slprj\raccel\MPM_v2
